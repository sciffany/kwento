-- CreateEnum
CREATE TYPE "BlogCardType" AS ENUM ('TEXT', 'IMAGE');
...
CREATE TABLE "BlogCard" (
    ...
    "image" TEXT,
    "blogCardType" "BlogCardType" NOT NULL,
    "voiceUrl" TEXT,
    "blogId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "BlogCard" ADD CONSTRAINT "BlogCard_blogId_fkey" FOREIGN KEY ("blogId") REFERENCES "Blog"("id") ON DELETE SET NULL ON UPDATE CASCADE;
